...
glm::mat4 Core::createViewMatrix(glm::vec3 position, glm::vec3 forward, glm::vec3 up, float yaw, float pitch, float roll)
{
	glm::vec3 side = glm::cross(forward, up);
	glm::mat4 cameraRotation;
	cameraRotation[0][0] = side.x; cameraRotation[1][0] = side.y; cameraRotation[2][0] = side.z;
	...
	//return M;
	return RotMatrix * cameraRotation * cameraTranslation;
}